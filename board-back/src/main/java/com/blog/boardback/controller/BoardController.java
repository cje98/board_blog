...
public class BoardController {
    ...
    // EndPoint가 두 개지만 하나의 메소드로 작성해줌
    // PathVariable은 기본적으로 필수로 파라미터를 받기 때문에 required = false 처리
    ...
    public ResponseEntity<? super DeleteBoardResponseDto> deleteBoard(
        @PathVariable("boardNumber") Integer baordNumber,
        @AuthenticationPrincipal String email
    ){
        ResponseEntity<? super DeleteBoardResponseDto> response = boardService.deleteBoard(baordNumber, email);
        return response;
    }
}
